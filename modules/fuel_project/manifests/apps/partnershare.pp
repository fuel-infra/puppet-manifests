...
# you have to use rsync+ssh/scp method and upload to 'partnershare' user with
# '/var/www/partnershare' location. All the files will be available on the
# 'share.fuel-infra.org' address and will require a line in 'htpasswd_content'
# with account generated by 'htpasswd'.
#
# Parameters:
#   [*authorized_key*] - ssh key used to upload files
#   [*htpasswd_content*] - htpasswd file content with partners accounts and passwords
#
class fuel_project::apps::partnershare (
  $authorized_key,
  $htpasswd_content = '',
